...
public class CustomerController {
    ...
    private final ICustomerServices iCustomerService;

    public CustomerController(ICustomerServices iCustomerService) {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id")
        ...
        CustomerDetailsDto customerDetailsDto = iCustomerService.fetchCustomerDetailsDto(mobileNumber, correlationId);
